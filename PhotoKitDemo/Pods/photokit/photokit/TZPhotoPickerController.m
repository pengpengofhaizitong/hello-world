...
- (void)configCollectionView {
    ...
    [_collectionView registerNib:[UINib nibWithNibName:@"TZAssetCell" bundle:bundle] forCellWithReuseIdentifier:@"TZAssetCell"];
}
...
- (void)configBottomToolBar {
    ...
    if (imagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamed:@"PhotoKitBundle.bundle/photo_original_def"] forState:UIControlStateNormal];
...
//            for (id item in photos) { if ([item isKindOfClass:[NSNumber class]]) return; }
            ...
            if ([imagePickerVc.pickerDelegate respondsToSelector:@selector(imagePickerController:didFinishPickingPhotos:sourceAssets:SelectImageArr:)]) {
                [imagePickerVc.pickerDelegate imagePickerController:imagePickerVc didFinishPickingPhotos:photos sourceAssets:assets  SelectImageArr:_selectedPhotoArr];
            }
            if ([imagePickerVc.pickerDelegate respondsToSelector:@selector(imagePickerController:didFinishPickingPhotos:sourceAssets:infos:SelectImageArr:)]) {
                [imagePickerVc.pickerDelegate imagePickerController:imagePickerVc didFinishPickingPhotos:photos sourceAssets:assets infos:infoArr  SelectImageArr:_selectedPhotoArr];
            }
